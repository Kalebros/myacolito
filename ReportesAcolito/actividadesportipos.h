...
#ifndef ACTIVIDADESPORTIPOS_H
#define ACTIVIDADESPORTIPOS_H
...
/*!
  Reporte de actividades por tipos

 */

class REPORTESACOLITOSHARED_EXPORT ActividadesPorTipos : public BReport
{
    Q_OBJECT
public:
    Q_INVOKABLE explicit ActividadesPorTipos(QObject *parent = 0);
