...
#ifndef ACTIVIDADESPORLOCALIZACION_H
#define ACTIVIDADESPORLOCALIZACION_H
...
class REPORTESACOLITOSHARED_EXPORT ActividadesPorLocalizacion : public BReport
{
    Q_OBJECT
public:
    Q_INVOKABLE explicit ActividadesPorLocalizacion(QObject *parent = 0);
...
#endif // ACTIVIDADESPORLOCALIZACION_H
